...
|---|---|
| What is this repository and what can be installed? | `README.md` |
| Which Skills exist and where are they? | `skills-lock.json` |
| How are Skills independently versioned and released? | `VERSIONING.md` |
| How must agents work in this repository? | `AGENTS.md` |
...
| How does a member session find siblings or teams and decide task relevance? | [`MULTI-REPO-HARNESS.md` - Find Sibling Scope and Decide Relevance](MULTI-REPO-HARNESS.md#find-sibling-scope-and-decide-relevance) / `HARNESS-OPERATIONS.md` |
...
Read only the sources needed for the task. A referenced target or coordinating
repository always outranks this repository for its local truth.
